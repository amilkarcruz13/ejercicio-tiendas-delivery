class Tienda:
    ...
    def detalle(self, posicion):
        ...
        print("Dirección: {}".format(self.direccion[posicion]))
        print("Categoria: {}".format(self.categoria[posicion]))
        pass
    def usuarioBuscar(self):
        categoria = input("Escriba de la categoria a buscar: \n")
...
tiendas.guardarTienda("El tren rojo", "Hamburguesas 12Bs", "2do anillo", "Restaurant")
